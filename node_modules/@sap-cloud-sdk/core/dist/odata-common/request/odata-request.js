...
var ODataRequest = /** @class */ (function () {
    ...
    ODataRequest.prototype.relativeUrl = function (includeServicePath, includeQueryParameters) {
        ...
        return "" + remove_slashes_1.removeTrailingSlashes(this.relativeResourceUrl(includeServicePath)) + this.config.appendedPaths.join('') + query;
    };
    /**
    ...
    ODataRequest.prototype.defaultHeaders = function () {
        ...
        return util_1.mergeIgnoreCase(util_1.pickNonNullish(this.config.defaultHeaders), additionalHeaders);
    };
    /**
    ...
    ODataRequest.prototype.getAdditionalHeadersForKeys = function () {
        ...
        var destinationHeaders = util_1.pickIgnoreCase.apply(void 0, __spreadArray([(_a = this.destination) === null || _a === void 0 ? void 0 : _a.headers], keys));
        var customHeaders = util_1.pickIgnoreCase.apply(void 0, __spreadArray([this.customHeaders()], keys));
        return util_1.mergeIgnoreCase(destinationHeaders, customHeaders);
    };
