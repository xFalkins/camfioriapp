...
function getAuthHeaders(destination, customHeaders) {
    return __awaiter(this, void 0, void 0, function () {
        var customAuthHeaders, additionalDestinationAuthHeaders;
        return __generator(this, function (_a) {
            ...
            additionalDestinationAuthHeaders = getCustomAuthHeaders(destination, destination.headers);
            if (Object.keys(customAuthHeaders).length) {
                return [2 /*return*/, customAuthHeaders];
            }
            if (Object.keys(additionalDestinationAuthHeaders).length) {
                return [2 /*return*/, additionalDestinationAuthHeaders];
            }
            return [2 /*return*/, buildAuthorizationHeaders(destination)];
        });
    });
}
