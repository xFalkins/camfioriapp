...
function serviceToken(service, options) {
    return __awaiter(this, void 0, void 0, function () {
        var resolvedService, opts, xsuaa, serviceCreds, cachedToken, resp, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    resolvedService = environment_accessor_1.resolveService(service);
                    opts = __assign({ useCache: true, enableCircuitBreaker: true }, options);
                    ...
                    if (opts.useCache) {
                        ...
                        if (cachedToken) {
                            return [2 /*return*/, cachedToken.access_token];
                        }
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, xsuaa_service_1.clientCredentialsGrant(xsuaa, serviceCreds, opts)];
                case 2:
                    resp = _a.sent();
                    if (opts.useCache) {
                ...
                case 3:
                    error_1 = _a.sent();
                    throw new util_1.ErrorWithCause("Fetching an access token for service \"" + resolvedService.label + "\" failed.", error_1);
